...
- [Pat Helland: Immutability Changes Everything](https://archive.org/details/vimeo-52831373)
...
- [Okay, Color Spaces](https://ericportis.com/posts/2024/okay-color-spaces/): Brief tour of color spaces and why they're all confusing.
- [Seeing Like a Software Company](https://www.seangoedecke.com/seeing-like-a-software-company/): Why large companies grow processes that (outwardly) seem absurd.
...
- [Nexus Trilogy (Ramez Naam)](https://www.goodreads.com/series/86731-nexus): Nexus is Linux if it ran on your brain. Society is becoming post-human and governments fight violently to keep control. Rich universe, good characters, plausible technology. Each book is better than the last.
